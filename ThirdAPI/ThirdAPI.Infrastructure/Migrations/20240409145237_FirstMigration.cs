    ...
    public partial class FirstMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Descricao = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Preco = table.Column<decimal>(type: "decimal(10)", precision: 10, nullable: false),
                    ...
                    DataCadastro = table.Column<DateTime>(type: "datetime(6)", nullable: false, defaultValue: new DateTime(2024, 4, 9, 14, 52, 37, 129, DateTimeKind.Utc).AddTicks(365)),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "material", "Material Escolar" },
                    { 2, "eletronicos.jpg", "Eletônicos" },
