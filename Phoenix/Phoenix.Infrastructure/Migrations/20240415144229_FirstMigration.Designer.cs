...
namespace Phoenix.Infrastructure.Migrations
{
    ...
    [Migration("20240415144229_FirstMigration")]
            ...
            modelBuilder.Entity("Phoenix.Domain.Entities.Cliente", b =>
                {
                    ...
                    b.Property<DateTime>("DataCadastro")
                        ...
                        .HasDefaultValue(new DateTime(2024, 4, 15, 14, 42, 29, 394, DateTimeKind.Utc).AddTicks(7807));
            ...
            modelBuilder.Entity("Phoenix.Domain.Entities.Compra", b =>
                {
                    ...
                    b.Property<DateTime>("DataCompra")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 4, 15, 14, 42, 29, 394, DateTimeKind.Utc).AddTicks(9964));
            ...
            modelBuilder.Entity("Phoenix.Domain.Entities.DevolucaoVenda", b =>
                {
                    ...
                    b.Property<DateTime>("DataDevolucao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 4, 15, 14, 42, 29, 395, DateTimeKind.Utc).AddTicks(3160));
            ...
            modelBuilder.Entity("Phoenix.Domain.Entities.Entrega", b =>
                {
                    ...
                    b.Property<DateTime>("DataEntrega")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 4, 15, 14, 42, 29, 395, DateTimeKind.Utc).AddTicks(6433));
            ...
            modelBuilder.Entity("Phoenix.Domain.Entities.Funcionario", b =>
                {
                    ...
                    b.Property<DateTime>("Admissao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 4, 15, 14, 42, 29, 396, DateTimeKind.Utc).AddTicks(4045));
            ...
            modelBuilder.Entity("Phoenix.Domain.Entities.Produto", b =>
                {
                    ...
                    b.Property<DateTime>("DataCadastro")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 4, 15, 14, 42, 29, 396, DateTimeKind.Utc).AddTicks(6098));
            ...
            modelBuilder.Entity("Phoenix.Domain.Entities.Venda", b =>
                {
                    ...
                    b.Property<DateTime>("DataVenda")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 4, 15, 14, 42, 29, 397, DateTimeKind.Utc).AddTicks(305));
